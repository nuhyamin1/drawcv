...
New scenes use schema **1.12**, including vector patterns, reusable path markers, retained text runs, path clips, paints, and effects.
Schemas 1.0 through 1.11 load with compatible defaults. Older readers reject 1.12;
...
| Persistence | JSON 1.12; forward migration; cloning; undo/redo | Direct edits require transaction discipline; older readers need updating |
