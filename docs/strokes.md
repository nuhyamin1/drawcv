...
- Scene files now write schema **1.13**. Schemas 1.0 through 1.12 migrate forward;
  omitted stroke space defaults to `"screen"`. Older
  readers reject 1.13 rather than silently discarding new styling. Keep old readers
